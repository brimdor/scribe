...
- `src/services/openai.js`: Manual-provider orchestration plus OAuth tool routing and direct note-publish fallback for grounded note workflows (Added: 2026-03-10, Updated: 2026-03-11, Feature: 008)
